...
\item A continuación calculamos el ángulo entre los puntos, los normalizamos con el ángulo de norma y lo transformamos en un ángulo entre 0 y $2\pi$.
\begin{verbatim}
...
\end{verbatim}
\item Al igual que con las distancias, fabricamos un contador para alacenar en que contenedor se encuentra el punto. Por último guardamos toda la información en un vector.
\begin{verbatim}
